...
%    /Subject (Praca dyplomowa inzynierska)
%    /Keywords ()
%}
...
\title{Struktura ramowa do przetwarzania danych senorycznych}
...
\hypersetup{
    ...
    linkcolor=black,
    urlcolor=black,
    pdftitle={Struktura ramowa do przetwarzania danych sensorycznych},
...
\input{2_porownanie}
\cleardoublepage
\input{3_architektura}
\cleardoublepage
\input{4_implementacja}
\cleardoublepage
\input{5_zadania}
\cleardoublepage
\input{6_wnioski}
